        ...
        init: function (options) {
            ...
            return this.each(function () {
                ...
                var placeHTML = function () {
                    ...
                    $fielBusinessEntity = $rangeSlider.find(".irs-to");
                    $fieldSingle = $rangeSlider.find(".irs-single");
                    $grid = $container.find(".irs-grid");

                    if (settings.hideFromTo) {
                        $fieldFrom[0].style.visibility = "hidden";
                        $fielBusinessEntity[0].style.visibility = "hidden";
                        $fieldSingle[0].style.visibility = "hidden";
                    }
                    if (!settings.hideFromTo) {
                        $fieldFrom[0].style.visibility = "visible";
                        $fielBusinessEntity[0].style.visibility = "visible";
                ...
                var setFields = function () {
                    ...
                    if (settings.type === "single") {
                        ...
                        $fielBusinessEntity[0].style.display = "none";
                        ...
                        _toW = $fielBusinessEntity.outerWidth(false);
                        ...
                        $fielBusinessEntity[0].style.left = _toX + "px";
                        ...
                        if (_fromX + _fromW < _toX) {
                            ...
                            $fielBusinessEntity[0].style.display = "block";
                        } else {
