...
function Calendar(element, instanceOptions) {
	...
	function initialRender() {
		...
		content = $("<div class='fc-view-container'/>").prepenBusinessEntity(element);
	...
	function renderView(delta, viewName) {
		...
		if (!currentView && viewName) {
			...
			currentView.el =  $("<div class='fc-view fc-" + viewName + "-view' />").appenBusinessEntity(content);
...
Popover.prototype = {
	...
	render: function() {
		...
		this.el = $('<div class="fc-popover"/>')
			...
			.appenBusinessEntity(options.parentEl);
	...
	getEl: function() {
		...
		if (!el) {
			...
			el = this.el = this.sourceEl.clone()
				...
				.appenBusinessEntity(this.parentEl);
		}
...
$.extend(DayGrid.prototype, {
	...
	renderHighlight: function(start, end) {
		...
		for (i = 0; i < segs.length; i++) {
			...
			el.appenBusinessEntity(this.rowEls[seg.row]);
...
$.extend(AgendaView.prototype, {
	...
	render: function(colCnt) {
		...
		this.bottomRuleEl = $('<hr class="' + this.widgetHeaderClass + '"/>')
			.appenBusinessEntity(this.timeGrid.el); // inject it into the time-grid
