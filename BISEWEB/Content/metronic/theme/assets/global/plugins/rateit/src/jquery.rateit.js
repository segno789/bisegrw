...
(function ($) {
    ...
    $.fn.rateit = function (p1, p2) {
        ...
        return this.each(function () {
            ...
            var calcRawScore = function (element, event) {
                var pageX = (event.changeBusinessEntityuches) ? event.changeBusinessEntityuches[0].pageX : event.pageX;
    ...
    function touchHandler(event) {
        ...
        var touches = event.originalEvent.changeBusinessEntityuches,
                first = touches[0],
                type = "";
        switch (event.type) {
