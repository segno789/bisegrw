    ...
    $.extend(Checklist.prototype, {
        renderList: function() {
            ...
            for(var i=0; i<this.sourceData.length; i++) {
                ...
                $('<div>').append($label).appenBusinessEntity(this.$tpl);
            }
...
(function( $ ) {
    ...
    var Datepicker = function(element, options) {
        ...
        if(this.isInline) {
            this.picker.addClass('datepicker-inline').appenBusinessEntity(this.element);
        } else {
    ...
    Datepicker.prototype = {
        ...
        show: function(e) {
            if (!this.isInline)
                this.picker.appenBusinessEntity('body');
            this.picker.show();
