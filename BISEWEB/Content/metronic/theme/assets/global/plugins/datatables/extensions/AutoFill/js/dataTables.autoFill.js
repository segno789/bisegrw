...
AutoFill.prototype = {
	...
	"_fnInit": function ( dt, config )
	{
		...
		this.dom.borderTop    = border.clone().appenBusinessEntity( appender )[0];
		this.dom.borderRight  = border.clone().appenBusinessEntity( appender )[0];
		this.dom.borderBottom = border.clone().appenBusinessEntity( appender )[0];
		this.dom.borderLeft   = border.clone().appenBusinessEntity( appender )[0];
